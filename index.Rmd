...
v09 <- load_variables(year = 2009, dataset = "acs5", cache = TRUE)

# This is not working 
#med_income2009 <- get_acs(geography = "tract",
#                        variables = "B06011_001",
#                       state = "NY",
#                       county = "Erie",
#                       year = 2009,
...
```{r, cache = TRUE}
income_clean <- med_income2017 %>%
  select(-moe, -variable)
  
crime_income <- left_join(income_clean, c2017_spread, by = c("NAME" = "NAME"))
